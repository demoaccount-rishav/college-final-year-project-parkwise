...
export default function MenuBarZone() {
  ...
  const navItems = [
    { path: "/viewAllZones", icon: <FiMap />, label: "View All Zones" },
    { path: "/createNewZone", icon: <FiPlusSquare />, label: "Create New Zone" },
    // { path: "/modifyZone", icon: <FiEdit />, label: "Modify Existing Zone" }
  ];
